...
function createApplication (name, dir) {
  ...
  pkg.dependencies.bcrypt = '^3.0.6'
  pkg.dependencies.jsonwebtoken = '^8.5.1'
  pkg.dependencies.mongoose = '^5.5.11'
  pkg.dependencies.nodemailer = '^6.2.1'
  ...
  mkdir(dir, 'config')
  copyTemplateMulti('js/routes', dir + '/Config', '*.js')

  // copy Constant templates
  mkdir(dir, 'Constant')
  copyTemplateMulti('js/Constant', dir + '/Constant', '*.js')

  // copy Constant templates
  mkdir(dir, 'controller')
  copyTemplateMulti('js/controller', dir + '/controller', '*.js')
  ...
  mkdir(dir, 'Model')
  copyTemplateMulti('js/Model', dir + '/Model', '*.js')

  // copy service templates
  mkdir(dir, 'service')
  copyTemplateMulti('js/service', dir + '/service', '*.js')

  // copy Utils templates
  mkdir(dir, 'Utils')
  copyTemplateMulti('js/Utils', dir + '/Utils', '*.js')
  ...
  // add config constant
  app.locals.requirModules.push('./config/connection.js')
  app.locals.requirModules.push('dotenv')
